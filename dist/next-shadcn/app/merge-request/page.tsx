...
import { Button, Badge, Alert, Tabs, Dropdown, Input, Table } from '../components/ui';
  ...
  return (
    <div id="gl-root" className={cx('pg-page', dark && 'gl-dark')}>
      ...
      <div className="pg-shell">
        ...
        <a key="合并请求" className={cx('pg-nav-link', 'is-active')} href="#merge-requests"><Icon name="mr" />合并请求<span className="pg-nav-count">3</span></a>
